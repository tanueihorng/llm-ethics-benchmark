...
> Your interim report (`docs/FYP_Report_2026-07-01_v5.docx`) already realizes most of
...
| 4 | **System Design & Implementation** | The *reusable artefact*: package architecture, config schema, plugin contract, model loader (incl. the quantization-engaged guard), matrix orchestration, SLURM, immutable-artifact + redaction discipline, and artifact-derived claim verification. This is the engineering contribution. | Ch4 |
