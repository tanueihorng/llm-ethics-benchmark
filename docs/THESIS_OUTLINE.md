...
| 4 | **System Design & Implementation** | The *reusable artefact*: package architecture, config schema, plugin contract, model loader (incl. the quantization-engaged guard), matrix orchestration, SLURM, immutable-artifact + redaction discipline, the 306-test suite. This is the engineering contribution. | Ch4 |
