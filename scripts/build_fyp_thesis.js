...
const ch2 = [
  ...
  PJ("HarmBench (Mazeika et al. 2024) provides a standardised red-teaming benchmark with an explicit behaviour taxonomy and, crucially, a fine-tuned classifier that scores whether a response actually exhibits the harmful behaviour — a deliberate move away from refusal-string matching. XSTest (Röttger et al. 2024) measures the opposite failure mode, over-refusal on benign prompts. Holistic frameworks such as HELM (Liang et al. 2022) formalise the idea that evaluation should be multi-metric and transparent. This thesis adopts HarmBench’s classifier-as-scorer principle as its primary instrument and treats refusal-matching only as a foil."),
  ...
  PJ("Existing work evaluates either full-precision models, or quantized models without controlling for confounds and scoring validity, or quantization accuracy without safety. No prior study, to the author’s knowledge, combines a matched-pair design, a judge-validated primary scorer with an independent cross-check, a capability anchor to separate alignment from capability, and a multi-precision sweep, on compact models across families. That combination is the gap this thesis fills."),
];
...
const ch3 = [
  ...
  PJ("Four benchmarks span the two axes of interest. Harmful compliance and over-refusal capture safety; MMLU and ARC-Challenge capture capability, with two independent benchmarks so that capability claims do not rest on a single test."),
...
const refs = [
  H1("References"),
  NUM("Liang, P. et al. (2022). Holistic Evaluation of Language Models. arXiv:2211.09110 (TMLR 2023).", "ref"),
  NUM("Mazeika, M. et al. (2024). HarmBench: A Standardized Evaluation Framework for Automated Red Teaming and Robust Refusal. ICML 2024. arXiv:2402.04249.", "ref"),
  NUM("Röttger, P. et al. (2024). XSTest: A Test Suite for Identifying Exaggerated Safety Behaviours in Large Language Models. NAACL 2024.", "ref"),
  NUM("Hendrycks, D. et al. (2021). Measuring Massive Multitask Language Understanding (MMLU). ICLR 2021.", "ref"),
  NUM("Clark, P. et al. (2018). Think You Have Solved Question Answering? Try ARC, the AI2 Reasoning Challenge. arXiv:1803.05457.", "ref"),
  NUM("Kharinaev, A. et al. (2025). Investigating the Impact of Quantization Methods on the Safety and Reliability of Large Language Models. arXiv:2502.15799.", "ref"),
  NUM("Jin, R. et al. (2024). A Comprehensive Evaluation of Quantization Strategies for Large Language Models. arXiv:2402.16775.", "ref"),
  NUM("Proskurina, I. et al. (2024). When Quantization Affects Confidence of Large Language Models? arXiv:2405.00632.", "ref"),
  NUM("Egashira, K. et al. (2024). Exploiting LLM Quantization. arXiv:2405.18137.", "ref"),
  NUM("Belkhiter, Y. et al. (2024). HarmLevelBench: Evaluating Harm-Level Compliance and the Impact of Quantization. arXiv:2411.06835.", "ref"),
  NUM("Gu, J. et al. (2024). A Survey on LLM-as-a-Judge. arXiv:2411.15594.", "ref"),
  NUM("Anonymous (2025). No Free Labels: Limitations of LLM-as-a-Judge Without Human Grounding. arXiv:2503.05061.", "ref"),
  NUM("Pineau, J. et al. (2021). Improving Reproducibility in Machine Learning Research (a report from the NeurIPS 2019 Reproducibility Program). JMLR 22.", "ref"),
  NUM("Sandve, G. K. et al. (2013). Ten Simple Rules for Reproducible Computational Research. PLOS Computational Biology 9(10): e1003285.", "ref"),
  NUM("Wilson, G. et al. (2017). Good Enough Practices in Scientific Computing. PLOS Computational Biology 13(6): e1005510.", "ref"),
  NUM("Smith, A. M. et al. (2018). Journal of Open Source Software (JOSS): Design and First-Year Review. arXiv:1707.02264.", "ref"),
];
