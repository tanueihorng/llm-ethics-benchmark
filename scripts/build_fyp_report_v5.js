...
const appendixD = [
  ...
  buildTable(
    ...
    [
      ...
      ["test_report_claims.py", "1", "Claim lock (D43): runs scripts/verify_report_claims.py — every load-bearing number in the canonical report builder is asserted against the committed analysis artifacts (43 checks); the report cannot drift from its evidence without failing the suite."],
