...
const ch6 = [
  ...
  buildTable(
    ...
    [
      ...
      ["qwen_4b", "HarmBench ASR", "0.860", "(pending)", "(pending)", "(pending)"],
      ["qwen_4b", "XSTest over-refusal", "0.016", "(pending)", "(pending)", "(pending)"],
      ["qwen_4b", "MMLU accuracy", "0.747", "(pending)", "(pending)", "(pending)"],
  ...
  P("Table 6.1  Per-pair results. Qwen 2B complete (jobs 60976+60977). Qwen 4B baseline complete (job 60978); 4-bit pending (job 60979 running at time of writing). Llama pair pending. Deltas and bootstrap 95% CIs will be added once each pair is complete.", { size: 18 }),
