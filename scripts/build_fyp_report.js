...
const appendixH = [
  ...
  PJ("The HarmBench judge validation is complete (job 61047) and the official classifier is the primary HarmBench scorer (decision D16); §6.12 carries the results. There is no pending scoring work. The remaining items are non-technical: push the latest commit to origin; send the supervisor progress note (T1); record the exact storage quota via `MyTCinfo` (T3, hardware already confirmed as a 32 GB Tesla V100); and prepare the final submission (T15)."),
