...
const ch1 = [
  ...
  ...numberedList([
    ...
    "A verification suite of 295 automated tests across twenty-three test files, covering schema validation, dataset loaders, the refusal parser (with comprehensive regression tests for the v2 expanded patterns), SLURM job generation, matrix reuse behaviour, analysis logic, v2 score-sidecar selection, and the judge-model validation layer (stub-backend tests, redaction enforcement, and an official-template regression check).",
  ]),
...
const ch5 = [
  ...
  buildTable(
    ...
    [
      ...
      ["pytest", "(installed via requirements.txt; 295 tests passing)"],
    ],
    [4200, 5160],
  ),
...
const appendixD = [
  ...
  PJ("The verification suite comprises 295 automated tests across twenty-three test files. The distribution is summarised in Table D.1; the test files are located under tests/ in the repository."),
  buildTable(
    ...
    [
      ...
      ["Total", "295", "Twenty-three files; all passing on the current commit."],
    ],
    [3000, 1200, 5160],
  ),
...
│   └── metrics/
├── tests/                    (295 tests across 23 files)
