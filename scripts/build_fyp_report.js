...
//   FYP_BUILD_SUPERSEDED=1 node scripts/build_fyp_report.js
// ============================================================================
if (!process.env.FYP_BUILD_SUPERSEDED) {
  console.error(
    "SUPERSEDED builder (scripts/build_fyp_report.js): refusing to build - its output is a " +
...
const ch1 = [
  ...
  ...numberedList([
    ...
    "A verification suite of 306 automated tests across twenty-three test files, covering schema validation, dataset loaders, the refusal parser (with comprehensive regression tests for the v2 expanded patterns), SLURM job generation, matrix reuse behaviour, analysis logic, v2 score-sidecar selection, and the judge-model validation layer (stub-backend tests, redaction enforcement, and an official-template regression check).",
  ]),
...
const ch5 = [
  ...
  buildTable(
    ...
    [
      ...
      ["pytest", "(installed via requirements.txt; 306 tests passing)"],
    ],
    [4200, 5160],
  ),
...
const refs = [
  ...
  ...numberedList([
    ...
    "Arditi, A., Obeso, O., Syed, A., Paleka, D., Panickssery, N., Gurnee, W., Nanda, N. Refusal in Language Models Is Mediated by a Single Direction. NeurIPS 2024; arXiv:2406.11717, 2024.",
    "Proskurina, I., Brun, L., Metzler, G., Velcin, J. When Quantization Affects Confidence of Large Language Models? Findings of NAACL 2024; arXiv:2405.00632, 2024.",
  ]),
];
...
const appendixD = [
  ...
  PJ("The verification suite comprises 306 automated tests across twenty-three test files. The distribution is summarised in Table D.1; the test files are located under tests/ in the repository."),
  buildTable(
    ...
    [
      ...
      ["Total", "306", "Twenty-three files; all passing on the current commit."],
    ],
    [3000, 1200, 5160],
  ),
...
│   └── metrics/
├── tests/                    (306 tests across 23 files)
...
const OUTPUT = path.join(__dirname, "..", "docs", "FYP_Report_2026-06-14.docx");
