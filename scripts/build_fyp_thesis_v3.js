...
//   FYP_BUILD_SUPERSEDED=1 node scripts/build_fyp_thesis_v3.js
// ============================================================================
if (!process.env.FYP_BUILD_SUPERSEDED) {
  console.error(
    "SUPERSEDED builder (scripts/build_fyp_thesis_v3.js): refusing to build - its output is a " +
...
const out = path.join(__dirname, "..", "docs", "FYP_Thesis_2026-06-26_v3.docx");
