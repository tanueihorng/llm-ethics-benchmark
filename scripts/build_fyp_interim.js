...
// Output: docs/FYP_Interim_2026-07-10.docx   (build: make interim)
...
const ch6 = [
  ...
  tbl(["Family", "Cohen’s κ (regex vs classifier)", "Reading"], [
    ["Qwen", "0.36 – 0.59", "fair to moderate; regex over-counts heavily (0.595 vs judge 0.255, 1.7B base)"],
    ["Mistral", "0.25 – 0.29", "fair, the lowest; regex 0.890 vs judge 0.565 (4-bit)"],
    ["Llama", "0.71 – 0.84", "substantial to almost perfect; little ambiguous middle ground"],
    ["Phi", "0.67 – 0.77", "substantial; like Llama"],
  ], [1900, 3660, 3800]),
...
const ch8 = [
  ...
  BUL("Sample size and power: 200 HarmBench prompts give wide (about ±0.05) confidence intervals; the minimum detectable ΔASR at 80% power is about 0.06 for a representative pair (0.04–0.09 across pairs), so effects below that floor cannot be ruled out (the smallest pair’s multi-seed sign-consistency is compatible with one)."),
...
const refs = [
  ...
  REF(16, "Q. McNemar, “Note on the sampling error of the difference between correlated proportions or percentages,” Psychometrika, vol. 12, no. 2, pp. 153–157, 1947."),
...
const out = "/Users/tanueihorng/fyp_quant/docs/FYP_Interim_2026-07-10.docx";
