...
const ch9 = [
  ...
  NUM("A second human annotator (inter-rater κ and adjudication of disagreements) extending the completed single-annotator human validation (classifier κ 0.59 vs regex 0.11 against human labels), and an open-weight guard model (e.g. Llama Guard [18]) for a fully reproducible cross-check.", "fw"),
