...
const ch9 = [
  ...
  NUM("Human-grounded judge validation (a stratified human-labelled subset reporting classifier-vs-human and regex-vs-human agreement; the annotation sheet is prepared) and an open-weight guard model (e.g. Llama Guard [17]) for a fully reproducible cross-check.", "fw"),
