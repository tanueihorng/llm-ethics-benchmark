...
def build_doc() -> None:
    ...
    add_scenario_table(
        ...
        [
            ...
            ("Implementation", "The main Codex session edits scripts/build_fyp_report.js if report-worthy, regenerates the report with make report, and updates docs/PROJECT_LOG.md."),
